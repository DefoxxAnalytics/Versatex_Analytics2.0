...
export const PERMISSION_DENIAL_MESSAGES: Record<Permission, string> = {
  ...
  upload: 'Data upload is available via the Admin Panel for Managers and Admins',
 ...
 */
export const ROLE_HIERARCHY: readonly UserRole[] = ['viewer', 'manager', 'admin'] as const;
 ...
 */
export function roleIsAtLeast(role: UserRole | null, minRole: UserRole): boolean {
  if (!role) return false;
